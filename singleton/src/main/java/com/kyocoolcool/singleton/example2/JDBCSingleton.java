package com.kyocoolcool.singleton.example2;

import java.sql.*;

/**
 * @author 陳金昌 Chris Chen
 * @version 1.0 2021/5/10 8:31 PM
 */
public class JDBCSingleton {
    ...
    private static Connection getConnection() throws ClassNotFoundException, SQLException {
        ...
        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/first", "root", "Kyo77437743");
        return con;
